 ...
 * iFI_AD_STRASSE_NR, String der der Straße (Wohnort) der Firma entspricht
...
BEGIN
    ...
    -- Optionale Adresse/Kontakt pro Firma überprüfen;
    SELECT ad_nr, ko_nr
    ...
    adress_loop: LOOP
        ...
        IF v_counter = 0 THEN
            -- Wir haben keinen Satz gefunden, wir kÃ¶nnen einen Insert starten
