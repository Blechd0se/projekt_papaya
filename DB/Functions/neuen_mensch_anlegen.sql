 ...
 * iAD_STRASSE_NR, String der der StraÃŸe (Wohnort) des Menschen entspricht
 ...
 * iPR_LEHRAUFTRAEGE, (Optional) String der den LehrauftrÃ¤gen des Menschen(Dozenten) entspricht
 * iPR_PRAK_TAETIG, (Optional) String der praktischen TÃ¤tigkeit des Menschen (Dozenten) entspricht
 * iPR_WEITERE_INFOS, (Optional) String der weitere Informationen enthÃ¤lt
